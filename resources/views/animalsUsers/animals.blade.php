...
<x-app-layout>
    ...
    <div class="alert alert-warning alert-dismissible fade show" role="alert">
        <strong>Olá, como está?

        </strong> Gostaria de lembrar que a exclusão de um animal sem vacinação só é possível após 7 dias do seu cadastro. Para os animais vacinados, a exclusão está disponível somente após decorridos 30 dias desde a última vacina aplicada.
        Agradecemos pela sua compreensão e atenção.
        Atenciosamente,
        VETGATE 💙

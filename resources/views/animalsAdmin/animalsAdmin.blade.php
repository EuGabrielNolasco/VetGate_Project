...
<x-app-layout>
    ...
    <div class="container mt-5">
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <!-- Meus animais -->
                <form action="{{ route('animals-admin-filter-my-Animals') }}" method="get" class="dropdown-item">
                    @csrf
                    <button type="submit" class="btn btn-link text-primary" style="display: flex; align-items: center;">
                        <svg height="30px" width="30px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" style="margin-right: 7px;">
	...
	c0,3.982-3.24,7.222-7.222,7.222c-13.172,0-23.889,10.717-23.889,23.889v14.445C453.194,354.236,456.925,357.967,461.527,357.967z" />
                ...
                <form action="{{ route('animals-admin-filter-non-vaccinated', ['page' => $animals->currentPage()]) }}" method="get" class="dropdown-item">
                    @csrf
                    <button type="submit" class="btn btn-link text-danger" style="display: flex; align-items: center;">
                        <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-right: 5px;">
                ...
                <!-- Animais vacinados -->
                <form action="{{ route('animals-admin-filter-vaccinated', ['page' => $animals->currentPage()]) }}" method="get" class="dropdown-item">
                    @csrf
                    <button type="submit" class="btn btn-link text-success" style="display: flex; align-items: center;">
                        <svg fill="green" height="30px" width="30px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 506.88 506.88" xml:space="preserve" style="margin-right: 5px;">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('inspeAdmin-inspect',['id'=>$animal->id]) }}" class="btn btn-primary">
                        ...
                        <td>
                            <a href="{{ route('vaccinations-index', ['id' => $animal->id]) }}" class="btn btn-primary">
                        ...
                        <td>
                            <a href="{{ route('animals-edit',['id'=>$animal->id]) }}" class="btn btn-primary">
